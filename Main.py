...
_max_allowed_connections = 2         # max user can connect 
_user_last_id = 0
_telegrambot_token = ''     # Create bot  in  @BotFather
_telegram_chat_id = '' # You can get this in @chatIDrobot.
def getUsers():
...
init();
schedule.every(10).minutes.do(checkNewUsers)        # set minutes to auto run script
while True:
